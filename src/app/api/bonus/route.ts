...
// GET /api/bonus - Obtener configuración de bonificación
export async function GET() {
  try {
    ...
    // Parsear targetIds de JSON string a array
...
// PUT /api/bonus - Actualizar configuración de bonificación (solo admin)
